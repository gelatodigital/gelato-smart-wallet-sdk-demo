 ...
 * Provides accessible dialog/modal functionality with animations
 */

// Root component that manages the state of the dialog
const Dialog = DialogPrimitive.Root

// Button that toggles the dialog open/closed state
const DialogTrigger = DialogPrimitive.Trigger

// Portal to render the dialog outside the DOM hierarchy
...
/**
 * DialogOverlay - Background overlay that covers the viewport when dialog is open
 * Includes animations for fade in/out effects
 */
...
/**
 * DialogTitle - Accessible title component for the dialog
 */
...
/**
 * DialogDescription - Accessible description component for the dialog
 */
